...
class groupPointMatchController:
	...
	def matchPoint(self):
		...
		standardMinx = getMinXValue(self.matrix.con)
		standardMiny = getMaxYValue(self.matrix.con)

		checkMinx = getMinXValue(checkMatrix.con)
		checkMiny = getMaxYValue(checkMatrix.con)
